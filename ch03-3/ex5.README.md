...
## 9. 실행 결과
<img width="827" height="222" alt="스크린샷 2026-03-22 164552" src="https://github.com/user-attachments/assets/215e6479-be10-4a8b-872f-d2ff8148883e" />
...
**실습과제 4** 에서는 sph1, sph2 가 main 함수 내부의 **지역 객체**이므로 main 이 실행된 후 선언문이 실행되는 시점에 생성자가 호출된다. 

**실습과제 5** 에서는 globalSph1, globalSph2 가 **전역 객체**이므로 프로그램이 시작되자마자 main 함수 실행 전에 생성자가 먼저 호출된다. 

...
```
밑변 4 높이 8 인 삼각형 생성     ← main 실행 전, 전역 객체 생성
밑변 2 높이 2 인 삼각형 생성     ← main 실행 전, 전역 객체 생성
삼각형의 면적은 16
삼각형의 면적은 2
밑변 2 높이 2 인 삼각형 소멸     ← 프로그램 종료 직전, 생성 역순으로 소멸
밑변 4 높이 8 인 삼각형 소멸     ← 프로그램 종료 직전, 생성 역순으로 소멸
```
